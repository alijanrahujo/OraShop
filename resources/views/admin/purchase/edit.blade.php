                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="supplier" value="{{ old('supplier', $purchase->supplier) }}" id="supplier" placeholder="Supplier">
                                        @error('supplier')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="reference_no" value="{{ old('reference_no', $purchase->reference_no) }}" id="reference_no" placeholder="Reference No">
                                        @error('reference_no')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status">
                                            ...
                                            <option value="3" {{ $purchase->status == 3 ? 'selected' : '' }}>Partial</option>
                                            <option value="2" {{ $purchase->status == 2 ? 'selected' : '' }}>Pending</option>
                                            <option value="1" {{ $purchase->status == 1 ? 'selected' : '' }}>Ordered</option>
                                        </select>
                                        @error('status')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="date" value="{{ old('date', $purchase->date) }}" id="date" placeholder="Date Purchase">
                                        @error('date')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <table class="table mt-3" id="accessory-table">
                                        ...
                                        <tbody>
                                            @foreach($purchaseDetails as $detail)
                                                <tr data-id="{{ $detail->accessory_id }}">
                                                    <td>{{ $detail->accessory->title }} <input type="hidden" name="accessory_id[]" value="{{ $detail->accessory_id }}"></td>
                                                    <td class="unit-price"><input type="number" class="form-control form-control-sm price-input" name="price[]" value="{{ $detail->unit_cost }}" min="1"></td>
                                                    <td><input type="number" class="form-control form-control-sm qty-input" name="qty[]" value="{{ $detail->qty }}" min="1"></td>
                                                    <td class="total">{{ ($detail->qty * $detail->unit_cost) }}</td>
