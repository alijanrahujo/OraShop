                ...
                <div class="page-title-box">
                    <div class="float-right">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Purchase Report</a></li>
                        ...
                        <table id="datatable-report" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                @foreach ($purchaseDetails as $purchaseDetail)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('storage/' . $purchaseDetail->accessory->image) }}"
                                                width="60"></td>
                                        <td>{{ $purchaseDetail->accessory->title }}</td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th colspan="2">{{$purchaseDetails->sum('unit_cost')}}</th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
