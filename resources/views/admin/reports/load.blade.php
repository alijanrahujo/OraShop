                ...
                <div class="page-title-box">
                    <div class="float-right">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Load Report</a></li>
                            <li class="breadcrumb-item active">Report</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Load Report</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ Route('report.load') }}" method="get">
                            <div class="row">
                                <div class="col-md-6">
