            ...
            <div class="col-lg-3">
                <div class="card card-eco">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                <h4 class="title-text mt-0">Purchase</h4>
                                <h3 class="font-weight-semibold mb-1">Rs: {{ number_format($purchase,2) }} </h3>
                                <p class="mb-0 text-muted text-truncate"><span class="text-success">
                                    {{-- <i class="mdi mdi-trending-up"></i>8.5%</span>Up From Yesterday</p> --}}
                            </div><!--end col-->
            ...
            <div class="col-lg-3">
                <div class="card card-eco">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                <h4 class="title-text mt-0">Sale</h4>
                                <h3 class="font-weight-semibold mb-1">Rs: {{ number_format($sale,2) }}</h3>
                                <p class="mb-0 text-muted text-truncate"><span class="text-success">
                                    {{-- <i class="mdi mdi-trending-up"></i>1.5%</span> Up From Last Week</p> --}}
                            </div><!--end col-->
                            <div class="col-4 text-center align-self-center">
                                <!-- <span class="card-eco-icon">🛒</span> -->
            ...
            <div class="col-lg-3">
                <div class="card card-eco">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                <h4 class="title-text mt-0">Stock</h4>
                                <h3 class="font-weight-semibold mb-1">{{ number_format($stock,0) }}</h3>
                                <p class="mb-0 text-muted text-truncate"><span class="text-danger">
                                    {{-- <i class="mdi mdi-trending-down"></i>3%</span> Down From Last Month</p> --}}
                            </div><!--end col-->
                            <div class="col-4 text-center align-self-center">
                                <!-- <span class="card-eco-icon">🎲</span> -->
            ...
            <div class="col-lg-3">
                <div class="card card-eco">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                <h4 class="title-text mt-0">Solid</h4>
                                <h3 class="font-weight-semibold mb-1">{{ number_format($solid,0) }}</h3>
                                <p class="mb-0 text-muted text-truncate"><span class="text-success">
                                    {{-- <i class="mdi mdi-trending-up"></i>10.5%</span> Up From Yesterday</p> --}}
                            </div><!--end col-->
                            <div class="col-4 text-center align-self-center">
                                <!-- <span class="card-eco-icon">💰</span> -->
