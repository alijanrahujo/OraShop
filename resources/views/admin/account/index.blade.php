    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="button-box">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createModal" data-whatever="@mdo">Add Account</button>
            </div>
            <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel1">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="createModalLabel1">Add Account</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="bank_name" class="control-label">Bank Name: <span class="text-danger">*</span></label>
            ...
            <div class="modal fade" id="depositModal" tabindex="-1" role="dialog" aria-labelledby="depositModalLabel1">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="depositModalLabel1">Deposit</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle">Account List</h6>
                        ...
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success deposit" data-account_id="{{$account->id}}" data-toggle="modal" data-target="#depositModal" data-whatever="@mdo">Deposit</button>
