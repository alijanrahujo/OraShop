                                    ...
                                    <div class="form-group position-relative" style="width: 100%;">
                                        ...
                                        <div id="suggestion-box" class="list-group position-absolute w-100" style="z-index: 1000; display: none;">
                                            @foreach ($accessories as $accessory)
                                                ...
                                                data-price="{{ $accessory->selling_price }}">
                                                    <strong>{{ $accessory->title }}</strong> - Rs. {{ $accessory->selling_price }}
                                                </a>
                                            @endforeach
                                        </div>
                                    </div>
                                    ...
                                    <table class="table mt-3" id="accessory-table">
                                        ...
                                        <tbody>
                                            @foreach($saleDetails as $detail)
                                                <tr data-id="{{ $detail->accessory_id }}">
                                                    ...
                                                    <td class="total">{{ number_format($detail->unit_cost * $detail->qty, 2) }}</td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th id="grand-total">{{ $sale->total_price }}</th>
                                                <th></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="date" value="{{ $sale->date }}" id="date">
                                        @error('date')
...
$(document).ready(function () {
    ...
    $(document).on("click", ".suggestion-item", function (e) {
        ...
        // Check if accessory already exists in table
        let exists = false;
        $("#accessory-table tbody tr").each(function() {
            if ($(this).data("id") === id) {
                exists = true;
