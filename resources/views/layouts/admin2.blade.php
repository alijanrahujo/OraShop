        ...
        <div class="left-sidenav">
            <ul class="metismenu left-sidenav-menu">
                ...
                <li class="{{ Request::routeIs('purchase.*') ? 'mm-active' : '' }}">
                    <a href="{{ Route('purchase.index') }}"><i class="ti-wallet"></i><span>Purchase</span><span class="menu-arrow"></span></a>
                </li>

                <li class="{{ Request::routeIs('pos.*') ? 'mm-active' : '' }}">
                    <a href="{{ Route('pos.index') }}"><i class="ti-package"></i><span>Sale</span><span class="menu-arrow"></span></a>
                </li>

                <li class="{{ Request::routeIs('report.stock') ? 'mm-active' : '' }}">
                    <a href="{{ Route('report.stock') }}"><i class="ti-package"></i><span>Stock</span><span class="menu-arrow"></span></a>
                </li>

                <li class="{{ Request::routeIs('report.sellClose') ? 'mm-active' : '' }}">
                    <a href="{{ Route('report.sellClose') }}"><i class="ti-package"></i><span>Sell close</span><span class="menu-arrow"></span></a>
                </li>

                <li class="{{ Request::routeIs('report.saleClose') ? 'mm-active' : '' }}">
                    <a href="{{ Route('report.saleClose') }}"><i class="ti-package"></i><span>Sell Close Report</span><span class="menu-arrow"></span></a>
                </li>
